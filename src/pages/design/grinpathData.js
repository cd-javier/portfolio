...
export const grinpathCaseStudy = {
  header: {
    ...
    details: [
      ...
      {
        heading: 'team',
        items: ['Beth Mac', 'Curtis Ross', 'Javier Quiroga'],
      },
      {
        heading: 'tools',
        items: ['Figma', 'Figjam', 'Trello', 'Procreate'],
      },
    ],
    intro: [
      {
  ...
  sections: [
    ...
    {
      heading: 'visual design & high fidelity',
      content: [
        {
          type: 'text',
          content: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'image',
          src: hiFi1,
          alt: 'High fidelity screens showing the primary pain relief path.',
          maxHeight: 500,
        },
        {
          type: 'text',
        ...
        },
        {
          type: 'image',
          src: hiFi2,
          alt: 'High fidelity screens showing the behavioural activation program.',
          maxHeight: 500,
        },
      ],
    },
    {
      heading: 'next steps & retrospective',
      content: [
        {
          type: 'text',
          content: [
