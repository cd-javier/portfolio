...
const lesgoCaseStudy = {
  header: {
    ...
    details: [
      {
        heading: 'tools',
        content: ['Figma', 'Figjam', 'Adobe Creative Suite'],
      },
      {
        heading: 'methods',
        content: ['User interviews', 'Competitor Analysis', 'Wireframing'],
      },
      {
  ...
  content: [
    ...
    [
      { type: 'h2', content: 'navigation refresh' },
      {
        type: 'div',
        className: 'text-body',
        content: [
    ...
    [
      { type: 'h2', content: 'user testing & iteration' },
      {
        type: 'div',
        className: 'text-body',
        content: [
    ...
    [
      ...
      { type: 'h2', content: 'lessons learned' },
      {
        type: 'div',
        className: 'text-body',
        content: [
