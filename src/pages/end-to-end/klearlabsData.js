import cover from '../../assets/img/case-studies/klearlabs/01-cover.webp';
import cafe from '../../assets/img/case-studies/klearlabs/02-cafe.webp';
import references from '../../assets/img/case-studies/klearlabs/03-references.webp';
import planMode from '../../assets/img/case-studies/klearlabs/04-plan-mode.webp';
import uiDetails from '../../assets/img/case-studies/klearlabs/05-ui-details.webp';
import shop from '../../assets/img/case-studies/klearlabs/06-shop.webp';
import result from '../../assets/img/case-studies/klearlabs/07-result.webp';

export const meta = {
  title:
    'Javier Quiroga | Klear Labs: End-to-End Design and Development with AI Tooling',
  description:
    'Designing, directing, and deploying a full website and online shop for a Notting Hill café using AI-powered development with Lovable, Claude, and Shopify.',
};

export const og = {
  title: 'Klear Labs: End-to-End Design and Development with AI Tooling',
  description:
    'Designing, directing, and deploying a full website and online shop for a Notting Hill café using AI-powered development.',
  image: 'https://javierquiroga.com/seo/og-image-klearlabs.jpg',
  url: 'https://javierquiroga.com/end-to-end/klear-labs',
  type: 'article',
};

export const klearlabsCaseStudy = {
  header: {
    heading: 'Klear Labs: end-to-end design and development with AI tooling',
    subheading:
      'Designing, directing, and deploying a full website and online shop for a Notting Hill café using AI-powered development.',
    img: {
      src: cover,
      alt: 'Decorative cover image for the Klear Labs case study',
    },
    details: [
      {
        heading: 'client',
        items: ['Klear Labs, Notting Hill'],
      },
      {
        heading: 'tools',
        items: ['Figma', 'Lovable', 'Shopify'],
      },
      {
        heading: 'timeline',
        items: ['~20 hours over 6 weeks'],
      },
      {
        heading: 'my role',
    ...
    intro: [
      ...
      },
      {
        type: 'image',
        src: cafe,
        alt: 'Interior of Klear Labs café on Golborne Road, Notting Hill',
        maxHeight: 300,
      },
      {
        type: 'text',
  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'image',
          src: references,
          alt: 'Screenshots of the three reference websites — seed.com, aesop.co.uk, and studiofeixen.ch — showing their visual direction',
          maxHeight: 500,
        },
        {
          type: 'text',
    ...
    {
      heading: 'exploration: going deep before pulling back',
      content: [
        {
          type: 'text',
          content: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'image',
          src: planMode,
          alt: "Screenshot of Lovable's plan mode showing a prompt and the generated build plan for the Klear Labs site",
          maxHeight: 400,
        },
        {
          type: 'text',
    ...
    {
      heading: 'the designer-developer gap',
      content: [
        {
          type: 'text',
          content: [
        ...
        },
        {
          type: 'image',
          src: uiDetails,
          alt: 'Collection of UI details from the live Klear Labs site showing cohesive buttons, product cards, and typography hierarchy across pages',
          maxHeight: 350,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'image',
          src: shop,
          alt: 'Screenshot of the Klear Labs shop page with the cart drawer open',
          maxHeight: 400,
        },
      ],
    },
    {
      ...
      content: [
          ...
          content: [
            {
              ...
              content: [
                ...
                {
                  type: 'a',
                  href: 'https://klear-labs.com',
                  content: 'klear-labs.com',
                  external: true,
                },
                {
                  type: 'text',
                  content:
                    ' with a fully functional shop connected to Shopify. The homepage runs edge to edge with no max-width constraint, holding up on large screens and scaling cleanly to mobile. The smoothies page carries a lot of text by necessity and is still navigable. Those were the two hardest layout problems to get right.',
                },
              ],
            },
            {
        ...
        },
        {
          type: 'image',
          src: result,
          alt: 'Klear Labs homepage on desktop and mobile, and the about page on desktop and mobile',
          maxHeight: 1600,
        },
      ],
    },
